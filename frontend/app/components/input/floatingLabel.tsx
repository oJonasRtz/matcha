		...
		<div className={`relative ${containerClassName}`.trim()}>
			<input
				...
				className={[
					...
					"placeholder:text-transparent focus:border-blue-400 focus:ring-2 focus:ring-blue-200/40",
			...
			<label
				...
				className={[
					...
					"peer-focus:top-2 peer-focus:translate-y-0 peer-focus:text-sm peer-focus:text-blue-300",
					"peer-not-placeholder-shown:top-2 peer-not-placeholder-shown:translate-y-0 peer-not-placeholder-shown:text-sm peer-not-placeholder-shown:text-blue-300",
					labelClassName,
				].join(" ")}
			>
				{label}
